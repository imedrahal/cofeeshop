  ...
  return (
    ...
    <div className="product-container-all">
      <div className="related-section">
        <h3 style={{textAlign: "center",fontSize: "2.5rem",fontWeight: "bold",}}>Featured products</h3>
        <div className="carousel-controls">
          <button className="carousel-btn" onClick={handlePrev} disabled={startIndex === 0}>
            <FaChevronLeft />
          </button>
          <div className="related-grid-all">
            {visibleProducts.map((p) => (
              <div className="related-card-all" key={p.id} onClick={() => setProduct(p)}>
